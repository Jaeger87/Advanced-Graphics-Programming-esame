...
Versor3 AxisAngle::axisX() const { return this->apply(Versor3::right()); }//todo: senza conversione
Versor3 AxisAngle::axisY() const { return this->apply(Versor3::up()); }
Versor3 AxisAngle::axisZ() const { return this->apply(Versor3::forward()); }

// conjugate
AxisAngle AxisAngle::operator * (AxisAngle r) const {
	Quaternion thisQ = Quaternion::from(*this);
	Quaternion rQ = Quaternion::from(r);
	return AxisAngle::from(thisQ * rQ);
}
